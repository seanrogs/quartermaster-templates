...
**Role mapping** from the Type string: contains "Pet" → not a roster role at all, see **Pets** below; else contains "Leader" → Leader; "Champion" → Champion; "Brute" → Brute; anything else (Ganger, Prospect, plain Beast, etc.) → Fighter, the default bucket.
