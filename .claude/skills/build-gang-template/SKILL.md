...
4. Validate the whole file with `plistlib.load` after each batch, and spot check a couple of fighters' full structure (`Attached Units` present with every pet type, tail fields correct).
